  ...
  return (
    <div className="lp">
      ...
      <div className="card fu" style={{ width: "100%", maxWidth: 400, borderRadius: 20, padding: 36 }}>
        ...
        <h2 style={{ fontSize: 24, fontWeight: 700, textAlign: "center", marginBottom: 7 }}>Welcome back</h2>
        <p style={{ color: "#5E7094", fontSize: 13, textAlign: "center", marginBottom: 28 }}>Sign in to continue your learning journey</p>
        ...
        <form onSubmit={submit}>
          ...
          <div style={{ position: "relative" }}>
            <input name="password" type={showPw ? "text" : "password"} className="inp" placeholder="••••••••" value={form.password} onChange={handle} required style={{ paddingRight: 44 }} />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "20px 0" }}>
          <div style={{ flex: 1, height: 1, background: "#1A2235" }} />
          <span style={{ color: "#2E3D5C", fontSize: 11 }}>or</span>
          <div style={{ flex: 1, height: 1, background: "#1A2235" }} />
        </div>

        <div style={{ textAlign: "center", color: "#5E7094", fontSize: 13 }}>
          Don't have an account?{" "}
          <Link to="/register" style={{ color: "#A78BFA", fontWeight: 500, textDecoration: "none" }}>Sign up free</Link>
        </div>
      </div>
    </div>
  );
